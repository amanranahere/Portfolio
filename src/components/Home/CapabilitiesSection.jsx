        ...
        <ul className="">
          {data.map((item, index) => {
            return (
              <motion.li
                key={index}
                className={`h-[70vh] md:h-[60vh] lg:h-[70vh] border-t-2 border-dotted border-[#6a6a6a] flex flex-col lg:flex-row bg-[#f1f1f1] sticky top-0 `}
                ...
                <div className="lg:w-[50%] md:px-20 lg:px-0">
                  ...
                  {item.buttonText && (
                    <div className="w-full flex justify-end lg:justify-start ">
                      <button className="px-6 py-2 text-black/70 border border-black/50 bg-[#f1f1f1] text-xs font-medium md:tracking-widest rounded-[0.21rem] hover:text-white hover:bg-black transition duration-300 active:scale-95 uppercase font-mono">
                        {item.buttonText}{" "}
