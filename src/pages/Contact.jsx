  ...
  return (
    <div className="pt-24 lg:pt-0 bg-[#343434] h-screen flex flex-col">
      <div className="flex flex-col lg:flex-row">
        <div className="p-8 pt-10 bg-gray-200 text-[4rem] md:text-[15vw] leading-[0.9] tracking-tight font-medium whitespace-nowrap flex justify-center items-center select-none">
          Let's Talk
        </div>

        <div className="bg-[#f7f7f7] flex flex-col justify-between p-4 gap-10 lg:gap-0">
          <div className="text-3xl md:pr-32 select-none">
